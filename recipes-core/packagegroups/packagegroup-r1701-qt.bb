...
#
## Uncomment the following line to add webengine support but remind to add also meta-python2 to the bblayer.
#
# QT5_IMAGE_INSTALL_append = " packagegroup-qt5-webengine"

#
## Uncomment the following line to add webkit support but remind that is considered obsolete since Qt 5.7
#
...
# Add packagegroup-qt5-webengine to QT5_RDEPENDS_mx6 & comment out the line below to install qtwebengine to the rootfs.
